...
Namespace Global.DXGI
    ...
    Public Interface IDXGIObject
        Function SetPrivateData(<MarshalAs(UnmanagedType.LPStruct)> Name As Guid, DataSize As UInteger, pData As IntPtr) As HRESULT
        Function SetPrivateDataInterface(<MarshalAs(UnmanagedType.LPStruct)> Name As Guid, pUnknown As IntPtr) As HRESULT
        Function GetPrivateData(<MarshalAs(UnmanagedType.LPStruct)> Name As Guid, ByRef pDataSize As UInteger, <Out> ByRef pData As IntPtr) As HRESULT
        Function GetParent(<MarshalAs(UnmanagedType.LPStruct)> riid As Guid, <Out> ByRef ppParent As IntPtr) As HRESULT
    End Interface
...
#End Region
        ...
        Function GetDevice(<MarshalAs(UnmanagedType.LPStruct)> riid As Guid, <Out> ByRef ppDevice As IntPtr) As HRESULT
    End Interface
